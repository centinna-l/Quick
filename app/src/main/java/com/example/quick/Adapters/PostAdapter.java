package com.example.quick.Adapters;

import android.content.Context;

import com.example.quick.CommentsActivity;
import com.example.quick.FollowersActivity;
import com.example.quick.Fragments.PostDetailFragment;
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (menuID == R.id.edit) {
                            ...
                            FirebaseDatabase.getInstance().getReference("PostsAndroid")
